...
#define APP_SPRAY_FHOP_FREQ_LVL_DEF     (int8_t)(75)     //default frequency
#define APP_SPRAY_FHOP_FREQ_LVL_MIN     (int8_t)(60)     //lowest frequency to try
#define APP_SPRAY_FHOP_FREQ_LVL_MAX     (int8_t)(90)     //highest frequency to try
...
extern void appFreqHop_Init(void)
{
    ...
    halFlashRead((uint8_t *)(&freq), sizeof(uint8_t));
...
extern void appFreqHop_SaveFreqToFlash(void)
{
    ...
    halFlashErase();
    halFlashWrite((uint8_t *)(&freqLevel), sizeof(uint8_t));
}
