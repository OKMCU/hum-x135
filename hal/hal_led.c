...
extern void halLedInit(void)
{
    ...
    P13_PushPull_Mode; //HAL_LED_0
    P14_PushPull_Mode; //HAL_LED_1
    P17_PushPull_Mode; //HAL_LED_2
    P30_PushPull_Mode; //HAL_LED_3
...
extern HAL_LED_STATE_t halLedState(HAL_LED_t led)
{
    ...
    {
        case HAL_LED_0:
            return (IO_LED_0 == 0) ? HAL_LED_STATE_OFF : HAL_LED_STATE_ON;
        case HAL_LED_1:
            return (IO_LED_1 == 0) ? HAL_LED_STATE_OFF : HAL_LED_STATE_ON;
        case HAL_LED_2:
            return (IO_LED_2 == 0) ? HAL_LED_STATE_OFF : HAL_LED_STATE_ON;
        case HAL_LED_3:
            return (IO_LED_3 == 0) ? HAL_LED_STATE_OFF : HAL_LED_STATE_ON;
        case HAL_LED_R:
