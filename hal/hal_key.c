...
#define HAL_KEY_IO_INIT()     st(SPL_GPIO_SET_MODE_P06_QUASI();\
                                 SPL_GPIO_SET_MODE_P07_QUASI();)

#if ( HAL_KEY_MAX > 0 )
#define HAL_STATE_KEY0()        spl_gpio_read_pin(SPL_GPIO_PIN_P06)
#endif
#if ( HAL_KEY_MAX > 1 )
#define HAL_STATE_KEY1()        spl_gpio_read_pin(SPL_GPIO_PIN_P07)
#endif
#if ( HAL_KEY_MAX > 2 )
